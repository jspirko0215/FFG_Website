...
if ($.fn.wl_Widget) $.fn.wl_Widget.defaults = {
    ...
    onDrag: function () {
        ...
        $(this).find('div.widget-content').each(function (i) {
            //wc=$(this);
            //console.log('drag');
            //console.log(wc.html());
            //$(this).replaceWith('<div class="widget-content"></div>');
            //$(this).hide();
        });
        $(this).find('div.widget-preview').each(function (i) {
            //$(this).show();
        });
        if ($(this).parent().attr("id") != 'widget-dock') {

        }
        else {
            var current = $(this);
            //console.log($(this));
            $('#widget-dock').find(' .widget').each(function (i) {
                //console.log($(this));
