...
$template['promo']['template'] = 'main_promo_template';
$template['promo']['regions'] = array(
   'header',
        'menu', 
        'slider',
   'content',
...
$template['promo']['parser'] = 'parser';
$template['promo']['parser_method'] = 'parse';
$template['promo']['parse_template'] = FALSE;
