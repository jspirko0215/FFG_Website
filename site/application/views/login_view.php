...
<?php } ?>
    ...
    <section>
        ...
        <div>
            <input type="password" id="password" name="password" value="<?php echo set_value('password', $password); ?>" />
    ...
    <section>
           ...
           <button id="bfb" class="fl bfacebook" title="Sign In with facebook"><img src="/images/facebook.png" />Sign In</button>
