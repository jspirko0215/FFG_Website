<div class="api_method">
    <a name="getGymStats"></a>
    <h2>getGymStats</h2>
    <p></p>
    <h4>URL: <a href="<?php echo $apidocs_base_url; ?>/api2/getGymStats"><?php echo $apidocs_base_url; ?>
            /api2/getGymStats</a></h4>
    ...
    <h4>REQUEST</h4>
    <pre>
<?php echo $apidocs_base_url; ?>/api2/getGymStats?gymId=1&fromDate=2012-01-06&endDate=2012-01-10
                            </pre>
    <h4>RESPONSE</h4>
